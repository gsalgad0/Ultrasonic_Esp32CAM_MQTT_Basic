/*
 * Lectura del sensor ultrasónico con ESP32CAM y MQTT
 * por: GSALGADO
 * Fecha: 01 de Octubre de 2021
 * 
 * Se utiliza bibloteca "ultrasonic" de Erik Simoes
 * 
...
//Datos de WiFi
const char* ssid = "INFINITUM9546";  // Aquí debes poner el nombre de tu red
const char* password = "Gx8J8F4Eh6";  // Aquí debes poner la contraseña de tu red
